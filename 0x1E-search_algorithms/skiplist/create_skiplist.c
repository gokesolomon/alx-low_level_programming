...
/**
 * init_express - the express lane of the linked list
 *
 ...
 *
 * @array: Point to the array used to fill the list
 * @size:  the array size
 *
 * Return: point to the head of the created list (NULL on failure)
 */
